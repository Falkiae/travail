...
class FrontController extends BaseController
{
    public function home(): void
    {
        ...
        $block_types = ['hero','services','two-col','how','reviews','zone','accordion','cta-final','heading','text','image','cta','html','video','file','quote','pricing','before-after','logos','seo-content','domicile-vs-atelier','sofa-simulator','prestation','car-zones'];
        $block_styles = '';
